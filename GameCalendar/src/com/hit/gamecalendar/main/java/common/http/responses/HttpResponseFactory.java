...
public class HttpResponseFactory {
    ...
    public static <E extends Exception> void CreateExceptionResponse(HttpExchange exchange, String message, E e) {
        try {
            Gson gson = new Gson();
            var errorResponse = new HttpExceptionResponse(message, e.toString() + " Stacktrace: " + Arrays.toString(e.getStackTrace()));
    ...
    public static <E extends Exception> void CreateExceptionResponse(HttpExchange exchange, E e) {
        try {
            Gson gson = new Gson();
            String respText = gson.toJson(new HttpExceptionResponse(e.getMessage(), e.toString()));
    ...
    public static <E extends NotFoundException> void CreateNotFoundResponse(HttpExchange exchange, String message, E e) {
        try {
            Gson gson = new Gson();
            var errorResponse = new HttpNotFoundResponse<>(message, e.toString() + " Stacktrace: " + Arrays.toString(e.getStackTrace()));
            String respText = gson.toJson(errorResponse);
